<?php
	...
	$config['tms_trailer_image_url'] = 'http://data.tmsapi.com/v1/screenplayTrailers?rootids=%1$sbitrateids=382&trailersonly=1&languageid=en&player_url=0&best_eclip=1&api_key=%2$s';
